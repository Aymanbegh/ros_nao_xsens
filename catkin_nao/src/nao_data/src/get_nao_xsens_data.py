...
"Device/SubDeviceList/RHipPitch/Position/Sensor/Value"]
	...
	def run(self):
	    ...
	    #data_v = list()
	    #v = list()
	    #v.append("anglesx_xsens")
	    #v.append("anglesx_nao")
	    ...
	    #line.append("RKneePitch")
	    #line.append("LKneePitch")
	    #line.append("RAnklePitch")
	    #line.append("LAnklePitch")
	    #line.append("RAnkleRoll")
	    #line.append("LAnkleRoll")
	    xsens1.append("sequence")
	    xsens1.append("angles_x")
	    xsens1.append("angles_y")
	    xsens1.append("angles_z")
	    xsens1.append("angul_x")
	    xsens1.append("angul_y")
	    xsens1.append("angul_z")
	    xsens1.append("acc_x")
	    xsens1.append("acc_y")
	    xsens1.append("acc_z")
	    data.append(line)
	    data_xsens.append(xsens1)
		...
		tic = timeit.default_timer()
			...
			#print("DATA acquisition: ")
    			orientation = [self.roll*180/pi, self.pitch*180/pi, self.yaw*180/pi]
			angular = [self.angular_x, self.angular_y, self.angular_z]
			linear = [self.linear_x, self.linear_y, self.linear_z]
			#print(orientation[0])
			#print(linear[0])
			memDatax = [self.time_stamp,orientation[0], orientation[1],orientation[2], angular[0], angular[1], angular[2], linear[0], linear[1], linear[2]]
			#memv = [orientation[0], memData[0]]			
			#jointdata
	    ...
	    output_xsens = os.path.abspath("/home/begh/DATA/DATA_xsens.csv")
	    #output_v = os.path.abspath("/home/begh/DATA/DATA_v.csv")
		...
		for xsens1 in data_xsens:
			fps.write("; ".join(str(z) for z in xsens1))
			fps.write("\n")

	    #with open(output_v,"w") as fpv:
		#for v in data_v:
		#	fpv.write("; ".join(str(o) for o in v))
		#	fpv.write("\n")
